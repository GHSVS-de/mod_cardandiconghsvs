...
{
	$wa->addInlineStyle(
'.entwicklungs.' . $modId . '{background-image: url("' . Uri::root(true) . '/' . HTMLHelper::_('cleanImageURL', $params->get('backgroundimage'))->url . '");}
', ['name' => $modId]);
}
...
<div id="<?php echo $modId; ?>" class="container-fluid mod_cardandiconghsvs entwicklungs <?php echo $modId; ?>">
